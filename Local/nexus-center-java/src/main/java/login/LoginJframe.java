...
public class LoginJframe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabelNomeCompleto.setFont(new java.awt.Font("Roboto", 1, 14)); // NOI18N
        jLabelNomeCompleto.setText("Nome Completo");
        Bacckground.add(jLabelNomeCompleto, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 190, -1, -1));
        ...
        txtNomeCompleto.setCaretColor(new java.awt.Color(0, 32, 79));
        txtNomeCompleto.setDisabledTextColor(new java.awt.Color(0, 32, 79));
        txtNomeCompleto.setSelectionColor(new java.awt.Color(0, 32, 79));
        Bacckground.add(txtNomeCompleto, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 215, 340, 30));
    ...
    private void btnLogarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLogarActionPerformed
        ...
        //Classes
        DadosEnviar dados = new DadosEnviar();

        // Validação Log
        setNomeDigitado(txtNomeCompleto.getText());
        setSenhaDigitada(txtSenha.getText());

        Maquina validMaquina = new Maquina(getNomeDigitado(), getSenhaDigitada());// Adicionado Construtor na classe máquina]
        ...
        try {
            // Objetos JDBC
            Maquina maquina = new Maquina(getNomeDigitado(), getSenhaDigitada());// Adicionado Construtor na classe máquina
            ...
            if (rsusariodao.next()) {
                ...
                //Enviando Dados
                dados.enviar(getNomeDigitado(), getSenhaDigitada());
