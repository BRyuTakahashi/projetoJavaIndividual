...
public class DadosEnviar {
    ...
    public void enviar(String nomeCompleto, String senha) {
        ...
        try {
            ...
            Maquina maquina = new Maquina(nomeCompleto, senha);// Adicionado Construtor na classe máquina
